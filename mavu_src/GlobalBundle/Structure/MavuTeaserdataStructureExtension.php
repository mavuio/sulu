...
#copy of ExcerptStructureExtension.php
...
use Sulu\Bundle\PageBundle\Content\Structure\ExcerptValueContainer;

/**
 * extends structure with seo content.
 */

class MavuTeaserdataStructureExtension extends AbstractExtension implements ExportExtensionInterface
{
    /**
     * name of structure extension.
     */
    public const EXCERPT_EXTENSION_NAME = 'mavu_teaserdata';
