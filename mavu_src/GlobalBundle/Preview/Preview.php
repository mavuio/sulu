...
namespace Mavu\GlobalBundle\Preview;
...
use Sulu\Bundle\PreviewBundle\Preview\PreviewCacheItem;
    ...
    */
    ...
    public function update(
        ...
        if(array_key_exists('blocks',$data)) { 
            $addonClasses=implode(" ", $this->twClassesCore->collectClassesFromBlocks($data['blocks']));
            $customCssFilename=basename($this->twClassesCore->writeClassFiles($addonClasses));
            $contentAddon="<link href=\"/fe_assets2/{$customCssFilename}\" rel=\"stylesheet\"/>";
        }
        ...
        return $this->renderPartial($cacheItem, $options).$contentAddon;
    }
