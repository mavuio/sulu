...
class NavigationTwigExtension extends AbstractExtension implements NavigationTwigExtensionInterface
{
    ...
    {
        return [
            new TwigFunction('mavu_navigation_root_flat', [$this, 'flatRootNavigationFunction']),
            new TwigFunction('mavu_navigation_root_tree', [$this, 'treeRootNavigationFunction']),
            new TwigFunction('mavu_navigation_flat', [$this, 'flatNavigationFunction']),
            new TwigFunction('mavu_navigation_tree', [$this, 'treeNavigationFunction']),
            new TwigFunction('mavu_breadcrumb', [$this, 'breadcrumbFunction']),
            new TwigFunction('mavu_navigation_is_active', [$this, 'navigationIsActiveFunction']),
        ];
    }
